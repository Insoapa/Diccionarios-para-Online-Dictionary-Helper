...
class esen_Spanishdict {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return 'Ingles.com EN->ES Dictionary';
        if (locale.indexOf('TW') != -1) return 'Ingles.com EN->ES Dictionary';
        return 'Ingles.com EN-ES Dictionary';
    }
    ...
    async findCambridge(word) {
        ...
        let base = 'https://www.ingles.com/traductor/';
