    ...
    renderCSS() {
        let css = `
            <style>
                ...
                ul.sents {font-size:0.8em; list-style:square inside; margin:3px 0;padding:5px;background:rgba(0,0,255,0.1); border-radius:5px;}
                li.sent  {margin:0; padding:0;}
                span.eng_sent {margin-right:5px; color:#0000FF;}
