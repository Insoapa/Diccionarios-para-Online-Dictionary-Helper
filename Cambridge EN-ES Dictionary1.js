    ...
    renderCSS() {
        let css = `
            <style>
                ...
                span.pos {font-size:0.75em; background-color:#FFFF00; color:#0000FF; padding:1px 4px; border-radius:3px;}
                span.tran {margin:0; padding:0;}
                span.eng_tran {margin-right:3px; padding:0;}
                span.chn_tran {font-size:1.0em; background-color:#008000; color:white; padding:1px 4px; border-radius:3px;}
                ul.sents {font-size:0.8em; list-style:square inside; margin:3px 0;padding:5px;background:rgba(255,255,00,0.1); border-radius:5px;}
